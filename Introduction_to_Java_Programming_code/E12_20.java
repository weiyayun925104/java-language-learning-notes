/*
  ...
  ..., chapter34. Write a program to remove the statement package chapteri; in
  ...
  srcRootDirectory. The root directory and chapteri may contain other folders
  and files. Use the following command to run the program:

  java E12_20 srcRootDirectory
*/
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (File f: chapterList) {
      if (f.isDirectory()) {
        ...
        // and for each .java file, remove the package statement for the
        ...
        for (File source: fileList) {
          ...
          try (
            ...
            // skip the first two lines, which are a package statement
            // and an empty line
            sourceInput.nextLine(); sourceInput.nextLine();
